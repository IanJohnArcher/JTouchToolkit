...
public class BasicRecorder implements Recorder, Runnable
{
    ...
    public BasicRecorder(Device device)
    {
        ...
        this.coOrdinateSystem = BasicRecorder.COORDINATE_3D;
    ...
    public void record()
    {
        ...
        {
            this.thread.start();
            support.fireRecorderStarted("BasicRecorder recording",BasicRecorder.EVENT_RECORDER_STARTED,new double[3],-1,"Recording");
        }
    }
    /**
    ...
    public void stop()
    {
        if(this.thread.isAlive())
        {
            ...
            support.fireRecorderStoped("BasicRecorder stopped",BasicRecorder.EVENT_RECORDER_STOPPED,new double[3],-1,"Stopped");
        }
    }
    /**
    ...
    public void setRate(long rate)
    {
        if(this.thread.isAlive())
            this.stop();
        this.rate = rate;
        support.fireRecorderUpdate("BasicRecorder record delay rate updated",BasicRecorder.EVENT_RECORDER_UPDATE,new double[3],-1,"Stopped");
    }
    /**
    ...
    public void setCoOrdinateSystem(int parameter)
    {
        ...
        switch(parameter)
        {
            ...
            case Recorder.COORDINATE_3D:
                ...
                support.fireRecorderUpdate("BasicRecorder coOrdinate System updated",BasicRecorder.EVENT_RECORDER_UPDATE,new double[3],-1,"Stopped");
                break;
        }
    }
    /**
    ...
    public void setCoOrdinateRecord(int parameter)
    {
        ...
        support.fireRecorderUpdate("BasicRecorder coOrdinate Record updated",BasicRecorder.EVENT_RECORDER_UPDATE,new double[3],-1,"Stopped");
    }

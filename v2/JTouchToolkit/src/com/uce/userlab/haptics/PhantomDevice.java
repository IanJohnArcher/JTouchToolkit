...
public class PhantomDevice implements Device, HDCallback
{
    ...
    public int HD_Callback(Object[] obj)
    {
        try{
            ...
            }catch(HDException exc)
            {
                support.fireDeviceManagementError("There has occured an error while manageing device information",
                        PhantomDevice.MANAGEMENT_ERROR_EVENT,this.currentPosition,this.currentButtons,
        ...
        }catch(Exception e)
        {
            ...
            if(e instanceof DeviceException)
                ...
                error = new DeviceException(this,"There has occured an error within the callback loop",PhantomDevice.DEVICE_ERROR_UNKNOWN,0);
    ...
    private void fireInputEvents() throws HDException
    {
        ...
        if(this.getCurrentButtons() != 0 && this.getLastButtons() == 0)
            support.fireDeviceInput("Button(s) Down", PhantomDevice.EVENT_BUTTONS_DOWN, this.currentPosition, this.currentButtons);
        if(this.getLastButtons() != 0 && this.currentButtons == 0)
            support.fireDeviceInput("Button(s) Up", PhantomDevice.EVENT_BUTTONS_UP, this.currentPosition, this.currentButtons);
        ...
        if(turnV > 0.00128)
            support.fireDeviceInput("Gimbal Joint 1 motion detected [turn]",PhantomDevice.EVENT_GIMBAL_JOINT_1_MOTION,this.currentPosition, this.currentButtons);
                
        if(tiltV > 0.00128)
            support.fireDeviceInput("Gimbal Joint 2 motion detected [tilt]",PhantomDevice.EVENT_GIMBAL_JOINT_2_MOTION, this.currentPosition, this.currentButtons);
            
        if(twistV > 0.00128)
            support.fireDeviceInput("Gimbal Joint 3 motion detected [twist]",PhantomDevice.EVENT_GIMBAL_JOINT_3_MOTION, this.currentPosition, this.currentButtons);
        ...
        if(disTrav > 0.266)
            support.fireDeviceInput("Motion detected",PhantomDevice.EVENT_MOTION,this.currentPosition,this.currentButtons);
    }
    ...
    public void makeCurrent() throws DeviceException
    {
        try{
            if(this.isDestroyed())
                throw new DeviceException(this, "The device connection has been destroyed, unable to contact device.", PhantomDevice.DEVICE_DESTROYED_ERROR,0);
    ...
    public void updateCalibration() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Calibration has been updated",PhantomDevice.UPDATE_CALIBRATION,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void setSoftwareVelocityLimit(double limit) throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Velocity Limit has been updated",PhantomDevice.UPDATE_SOFTWARE_VELOCITY_LIMIT,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void setSoftwareForceImpulseLimit(double limit) throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Force Impulse Limit has been updated",PhantomDevice.UPDATE_SOFTWARE_FORCE_IMPULSE_LIMIT,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void setForceRampingRate(double rate) throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Force Ramping Rate has been updated",PhantomDevice.UPDATE_FORCE_RAMPING_RATE,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void setSchedulerRate(long rate) throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Scheduler Rate has been updated",PhantomDevice.UPDATE_SCHEDULER_RATE,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void enableForceOutput() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Force Output has been enabled",PhantomDevice.FORCE_OUTPUT_ENABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void disableForceOutput() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Force Output has been disabled",PhantomDevice.FORCE_OUTPUT_DISABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void enableMaxForceClamping() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Max Force Clamping has been enabled",PhantomDevice.MAX_FORCE_CLAMPING_ENABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void disableMaxForceClamping() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Max Force Clamping has been disabled",PhantomDevice.MAX_FORCE_CLAMPING_DISABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void enableForceRamping() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Force Ramping has been enabled",PhantomDevice.FORCE_RAMPING_ENABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void disableForceRamping() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Force Ramping has been disabled",PhantomDevice.FORCE_RAMPING_DISABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void enableSoftwareForceLimit() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Force Limit has been enabled",PhantomDevice.SOFTWARE_FORCE_LIMIT_ENABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void disableSoftwareForceLimit() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Force Limit has been disabled",PhantomDevice.SOFTWARE_FORCE_LIMIT_DISABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void enableSoftwareForceImpulseLimit() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Force Impulse Limit has been enabled",PhantomDevice.SOFTWARE_FORCE_IMPULSE_LIMIT_ENABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void disableSoftwareForceImpulseLimit() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Force Impulse Limit has been disabled",PhantomDevice.SOFTWARE_FORCE_IMPULSE_LIMIT_DISABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void enableSoftwareVelocityLimit() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Velocity Limit has been enabled",PhantomDevice.SOFTWARE_VELOCITY_LIMIT_ENABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {
    ...
    public void disableSoftwareVelocityLimit() throws DeviceException
    {
        ...
        try{
            ...
            this.updated = true;
            support.fireDeviceUpdate("Software Velocity Limit has been disabled",PhantomDevice.SOFTWARE_VELOCITY_LIMIT_DISABLED,this.currentPosition,this.currentButtons);
        }catch(HDException e)
        {

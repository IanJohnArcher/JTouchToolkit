...
public class BasicPlayer implements Player, Runnable
{
    ...
    public void start()
    {
        if(!this.thread.isAlive())
        {
            ...
            if(this.coOrdinates.size() > 0)
            {
                ...
                this.rel.start();
                this.thread.start();
                support.firePlayingStarted("BasicPlayer started",this.EVENT_PLAYING_STARTED,this.position,this.count,"Playing");
            }
        }
    }
    /**
    ...
    public void stop()
    {
        if(this.thread.isAlive())
        {
            ...
            support.firePlayingStoped("BasicPlayer stopped",this.EVENT_PLAYING_STOPPED,this.position,this.count,"Stopped");
            this.reset();
        }
    }
    /**
    ...
    public void reset()
    {
        if(!this.thread.isAlive())
        {
            ...
            this.count = -1;
            this.position = null;
            support.firePlayerReset("BasicPlayer reset",this.EVENT_PLAYER_RESET,this.position,this.count,"Reset");
        }
    }
    /**
    ...
    public void skipForward()
    {
        ...
        support.firePlaySkipForward("BasicPlayer Skipped Forwards",this.EVENT_PLAYER_SKIPFORWARD,this.position,this.count,"Playing");
    }
    /**
    ...
    public void skipBackward()
    {
        ...
        this.position = this.coOrdinates.get(count).getLocation();
        this.rel.setLocation(this.position);
        support.firePlaySkipBackward("BasicPlayer Skipped Backwards",this.EVENT_PLAYER_SKIPBACKWARD,this.position,this.count,"Playing");
    }
    ...
    public void loadRecord(File file) throws IOException
    {
        try{
            ...
            if(doc.getDocumentElement().getNodeName().compareTo("MotionRecord") == 0)
            {
                ...
                support.fireFileLoaded("BasicPlayer has loaded file",this.EVENT_FILE_LOADED,this.position,this.count,"Stopped");
            }
    ...
    public void setPlayData(double[][] data) throws Exception
    {
        ...
        support.firePlayerUpdate("BasicPlayer new data loaded",this.EVENT_PLAYER_UPDATE,this.position,this.count,"Stopped");
    }
    /**
    ...
    public void setCoOrdinateSystem(int parameter)
    {
        ...
        switch(parameter)
        {
            ...
            case Recorder.COORDINATE_3D:
                ...
                support.firePlayerUpdate("BasicPlayer new coOrdinate System",this.EVENT_PLAYER_UPDATE,this.position,this.count,"Stopped");
                break;
        }
    }
    /**
    ...
    public void setCoOrdinateRecord(int parameter)
    {
        ...
        support.firePlayerUpdate("BasicPlayer new coOrdinate Record",this.EVENT_PLAYER_UPDATE,this.position,this.count,"Stopped");
    }
